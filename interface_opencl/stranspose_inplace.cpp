 ...
 *      @date January 2014
 *
 * @generated from ztranspose_inplace.cpp normal z -> s, Fri Jan 10 15:51:19 2014
 */
    ...
    cl_mem A, size_t offset, int lda, int m, magma_queue_t queue )
{
    ...
    if (in&1)
    {
        ...
        ckKernel = rt->KernelPool["stranspose_inplace_odd_kernel"];
    }
    else
    {
        //printf ("running even kernel\n");
        ckKernel = rt->KernelPool["stranspose_inplace_even_kernel"];
    }
