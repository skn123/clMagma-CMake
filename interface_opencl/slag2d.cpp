/*
    -- clMAGMA (version 1.1.0) --
       ...
       @generated from clag2z.cpp mixed zc -> ds, Fri Jan 10 15:51:19 2014
*/
                                ...
                                magma_queue_t queue)
{
    ...
    // in slag2d.cl
    if(N>1){
        ckKernel = rt->KernelPool["slag2d_generic"];
    }else{
        ckKernel = rt->KernelPool["slag2d_special"];
    }
    if (!ckKernel)
    {
...
/*
    ...
    *info = 0;
    ...
    return magmablas_slag2d_64_64_16_4_v2( m, n, SA, SA_offset, ldsa, A, A_offset, lda, queue);
}
