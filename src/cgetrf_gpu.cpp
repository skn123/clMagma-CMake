/*
    -- clMAGMA (version 1.1.0) --
       ...
       @generated from zgetrf_gpu.cpp normal z -> c, Fri Jan 10 15:51:17 2014
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= min(m,n))
    ...
    else
      {
        ...
        if ((m == n) && (m % 32 == 0) && (ldda%32 == 0))
          {
            ...
            magma_ctranspose_inplace( dAT, dAT_offset, ldda, lddat, queue );
          }
        else
          {
            dAT_offset = 0;
        ...
        if ((m == n) && (m % 32 == 0) && (ldda%32 == 0)) {
          magma_ctranspose_inplace( dAT, dAT_offset, lddat, ldda, queue );
        }
        else {
