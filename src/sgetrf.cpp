/*
    -- clMAGMA (version 1.1.0) --
       ...
       @author Stan Tomov
       @generated from zgetrf.cpp normal z -> s, Fri Jan 10 15:51:18 2014
*/
    ...
    *info = 0;
    ...
    if ( (nb <= 1) || (nb >= min(m,n)) ) {
        ...
        if (maxdim*maxdim < 2*maxm*maxn) {
            ...
            magma_stranspose_inplace( dAT, dAT_offset, ldda, lddat, queue[0] );
        }
        else {
        ...
        if (maxdim*maxdim < 2*maxm*maxn) {
            magma_stranspose_inplace(dAT, dAT_offset, lddat, ldda, queue[0] );
