 ...
 *     @date January 2014
 *
 * @generated from testing_zlaswp.cpp normal z -> d, Fri Jan 10 15:51:19 2014
 *
 **/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    TESTING_MALLOC_CPU( h_A1, double, n2 );
    TESTING_MALLOC_CPU( h_A2, double, n2 );
    TESTING_MALLOC_CPU( h_A3, double, n2 );
    TESTING_MALLOC_CPU( h_AT, double, n2 );
