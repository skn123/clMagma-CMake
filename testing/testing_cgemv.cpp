/*
    -- clMAGMA (version 1.1.0) --
       ...
       @generated from testing_zgemv.cpp normal z -> c, Fri Jan 10 15:51:19 2014
...
int main(int argc, char **argv)
{
    ...
    TESTING_MALLOC_PIN( A, magmaFloatComplex, szeA );
    TESTING_MALLOC_PIN( X, magmaFloatComplex, szeX );
    TESTING_MALLOC_PIN( Y, magmaFloatComplex, szeY );
    TESTING_MALLOC_PIN( Ymagma, magmaFloatComplex, szeY );
    TESTING_MALLOC_PIN( Ycpu, magmaFloatComplex, szeY );
