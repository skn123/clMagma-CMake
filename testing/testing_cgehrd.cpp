 ...
 *     @date January 2014
 *
 * @generated from testing_zgehrd.cpp normal z -> c, Fri Jan 10 15:51:20 2014
 *
 **/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    TESTING_MALLOC_PIN( tau,    magmaFloatComplex, N     );
    TESTING_MALLOC_PIN( h_R,    magmaFloatComplex, n2    );
    TESTING_MALLOC_PIN( h_R1,   magmaFloatComplex, n2    );
    ...
    if ( checkres ) {
        ...
        TESTING_MALLOC_PIN( twork, magmaFloatComplex, ltwork );
#if defined(PRECISION_z) || defined(PRECISION_c)
